            ...
            <div class="login_main_container">
                <div class="br12 align_center w-fit-content login_content bg-F5F5F5 ">
                    <center class="mb_70">
                        ...
                        <div class="text_24_700 text_404248 mb_15">Please update your new password.</div>
                    ...
                    <div class="">
                        <button type="submit" class="text_14_500 ff_dm_sans bg_FCAF3B br_6 cp_1 mybtn text-white">Update Password</button>
                    </div>
                </div>
            </div>
        </form>
